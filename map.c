...
int	draw_map(t_game *g)
{
	...
	while (y < g->parsing->height)
	{
		...
		while (x < g->parsing->width)
		{
			...
			if_not((void *)(long)(mlx_put_image_to_window(g->mlx, g->window, \
